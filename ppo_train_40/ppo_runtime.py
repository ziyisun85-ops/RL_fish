...
from launcher_config import build_wrapper_default_args, install_common_train_patches
...
class DynamicResizableDictRolloutBuffer(DictRolloutBuffer):
    """List-backed rollout buffer to avoid preallocating large observation tensors for PPO cycle training."""
...
def install_runtime_patches(parsed_args: Any) -> None:
